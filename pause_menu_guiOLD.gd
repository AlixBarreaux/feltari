...
# Buttons
onready var resume_button: Button = self.buttons_container.get_node("ResumeButton")
onready var options_button: Button = self.buttons_container.get_node("OptionsButton")
onready var quit_to_main_menu_button: Button = self.buttons_container.get_node("QuitToMainMenuButton")
...
func _physics_process(delta: float) -> void:
	if Input.get_action_strength("pause_menu"):
		self.show()
